<?php
/**
 * GrowthEngineAI LMS - Registration Page
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && 
    ...
    if (empty($errors)) {
        ...
        echo json_encode([
            ...
            'redirect' => $result['success'] ? 'login?registered=1' : null,
...
<head>
    ...
    <title>Register - GrowthEngineAI</title>
...
<body>
        ...
        <div class="auth-wrapper">
            <div class="auth-left">
                <div class="auth-left-content">
                    ...
                    <p>Join thousands of learners mastering in-demand tech skills. Create your account and get instant access to our platform.</p>
            ...
            <div class="auth-right">
                <div class="auth-form-container">
                    ...
                    <form method="POST" action="" class="auth-form">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if (isset($errors['first_name'])): ?>
                                        <div class="invalid-feedback d-block"><?php echo htmlspecialchars($errors['first_name']); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if (isset($errors['last_name'])): ?>
                                        <div class="invalid-feedback d-block"><?php echo htmlspecialchars($errors['last_name']); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="role-selector">
                                <label class="role-option <?php echo $formData['role'] === 'student' ? 'selected' : ''; ?>">
                                    <input type="radio" name="role" value="student" <?php echo $formData['role'] === 'student' ? 'checked' : ''; ?>>
                        ...
                        <div class="form-group">
                            <label class="terms-checkbox <?php echo isset($errors['terms']) ? 'is-invalid' : ''; ?>">
                    ...
                    <a href="<?php echo htmlspecialchars($googleAuthUrl); ?>" class="btn btn-google btn-auth mb-3">
    ...
    <script>
        ...
        document.querySelector('.auth-form').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    const fields = ['first_name', 'last_name', 'email', 'password', 'confirm_password', 'terms', 'role'];
        ...
        function resetButton(btn, btnText, originalText) {
            ...
            btn.querySelector('i').classList.add('bi-arrow-right');
        }
        ...
        function showFieldError(fieldId, message) {
            ...
            if (fieldId === 'terms') {
                input = document.querySelector('input[name="terms"]');
                if (input) {
