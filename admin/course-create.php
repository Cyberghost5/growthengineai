<?php
/**
 * GrowthEngineAI LMS - Admin Create Course
 */
...
<head>
    ...
    <title>Create Course - GrowthEngineAI Admin</title>
        ...
        <div class="container-fluid px-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="welcome-text">
                    ...
                    <p class="mb-0">Create a new course</p>
                </div>
                <div class="d-flex align-items-center gap-3">
                ...
                <div class="card p-4 mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Fill in the course details and publish when ready.</p>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php echo isset($errors['category_id']) ? 'is-invalid' : ''; ?>" id="category_id" name="category_id" required>
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?php echo (int)$category['id']; ?>" <?php echo (isset($_POST['category_id']) && (int)$_POST['category_id'] === (int)$category['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php echo isset($errors['instructor_id']) ? 'is-invalid' : ''; ?>" id="instructor_id" name="instructor_id" required>
                                    ...
                                    <?php foreach ($instructors as $instructor): ?>
                                        <option value="<?php echo (int)$instructor['id']; ?>" <?php echo (isset($_POST['instructor_id']) && (int)$_POST['instructor_id'] === (int)$instructor['id']) ? 'selected' : ''; ?>>
