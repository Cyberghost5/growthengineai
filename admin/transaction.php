...
<head>
    ...
    <title>Transaction <?php echo htmlspecialchars($tx['reference']); ?> - GrowthEngineAI Admin</title>
        ...
        <div class="container-fluid px-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="welcome-text">
                    ...
                    <p class="mb-0">Transaction detail</p>
                </div>
                <div class="d-flex align-items-center gap-3">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <div class="sidebar-nav">
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link" href="transactions.php"><i class="bi bi-receipt"></i> Transactions</a>
                ...
                <div class="card p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Reference: <?php echo htmlspecialchars($tx['reference']); ?></p>
                        </div>
                        <div>
