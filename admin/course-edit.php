<?php
/**
 * GrowthEngineAI LMS - Admin Edit Course
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $publishedAt = $isPublished ? ($course['published_at'] ?: date('Y-m-d H:i:s')) : null;
        ...
        if ($saved) {
            if ($instructorId !== (int)$course['instructor_id']) {
                $db->prepare("UPDATE instructors SET total_courses = GREATEST(total_courses - 1, 0) WHERE id = ?")->execute([(int)$course['instructor_id']]);
...
$values = [
    ...
    'slug' => $_POST['slug'] ?? $course['slug'],
    'subtitle' => $_POST['subtitle'] ?? $course['subtitle'],
    'description' => $_POST['description'] ?? $course['description'],
    'category_id' => $_POST['category_id'] ?? $course['category_id'],
    'instructor_id' => $_POST['instructor_id'] ?? $course['instructor_id'],
    'level' => $_POST['level'] ?? $course['level'],
    'language' => $_POST['language'] ?? $course['language'],
    'duration_hours' => $_POST['duration_hours'] ?? $course['duration_hours'],
    'price' => $_POST['price'] ?? $course['price'],
    'sale_price' => $_POST['sale_price'] ?? $course['sale_price'],
    'thumbnail' => $_POST['thumbnail'] ?? $course['thumbnail'],
    'preview_video' => $_POST['preview_video'] ?? $course['preview_video'],
    'requirements' => $_POST['requirements'] ?? jsonToLines($course['requirements']),
    'what_you_learn' => $_POST['what_you_learn'] ?? jsonToLines($course['what_you_learn']),
    'target_audience' => $_POST['target_audience'] ?? jsonToLines($course['target_audience']),
    'is_free' => $isPost ? (isset($_POST['is_free']) ? 1 : 0) : (int)$course['is_free'],
    'is_featured' => $isPost ? (isset($_POST['is_featured']) ? 1 : 0) : (int)$course['is_featured'],
...
<head>
    ...
    <title>Edit Course - GrowthEngineAI Admin</title>
        ...
        <div class="container-fluid px-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="welcome-text">
                    ...
                    <p class="mb-0">Update course details</p>
                </div>
                <div class="d-flex align-items-center gap-3">
                ...
                <div class="card p-4 mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Make changes and save updates.</p>
                        </div>
                    ...
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?php echo isset($errors['title']) ? 'is-invalid' : ''; ?>" id="title" name="title" value="<?php echo htmlspecialchars($values['title']); ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?php echo isset($errors['slug']) ? 'is-invalid' : ''; ?>" id="slug" name="slug" value="<?php echo htmlspecialchars($values['slug']); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="subtitle" name="subtitle" value="<?php echo htmlspecialchars($values['subtitle']); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php echo isset($errors['category_id']) ? 'is-invalid' : ''; ?>" id="category_id" name="category_id" required>
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?php echo (int)$category['id']; ?>" <?php echo ((int)$values['category_id'] === (int)$category['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php echo isset($errors['instructor_id']) ? 'is-invalid' : ''; ?>" id="instructor_id" name="instructor_id" required>
                                    ...
                                    <?php foreach ($instructors as $instructor): ?>
                                        <option value="<?php echo (int)$instructor['id']; ?>" <?php echo ((int)$values['instructor_id'] === (int)$instructor['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select <?php echo isset($errors['level']) ? 'is-invalid' : ''; ?>" id="level" name="level" required>
                                    <option value="beginner" <?php echo ($values['level'] === 'beginner') ? 'selected' : ''; ?>>Beginner</option>
                                    <option value="intermediate" <?php echo ($values['level'] === 'intermediate') ? 'selected' : ''; ?>>Intermediate</option>
                                    <option value="advanced" <?php echo ($values['level'] === 'advanced') ? 'selected' : ''; ?>>Advanced</option>
                                    <option value="all_levels" <?php echo ($values['level'] === 'all_levels') ? 'selected' : ''; ?>>All Levels</option>
                                </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="language" name="language" value="<?php echo htmlspecialchars($values['language']); ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="duration_hours" class="form-label">Duration (Hours)</label>
                                <input type="number" step="0.1" class="form-control <?php echo isset($errors['duration_hours']) ? 'is-invalid' : ''; ?>" id="duration_hours" name="duration_hours" value="<?php echo htmlspecialchars($values['duration_hours']); ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="status" name="status">
                                    ...
                                    <option value="pending_review" <?php echo ($values['status'] === 'pending_review') ? 'selected' : ''; ?>>Pending Review</option>
                                    <option value="published" <?php echo ($values['status'] === 'published') ? 'selected' : ''; ?>>Published</option>
                                    <option value="archived" <?php echo ($values['status'] === 'archived') ? 'selected' : ''; ?>>Archived</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label for="price" class="form-label">Price</label>
                                <input type="number" step="0.01" class="form-control <?php echo isset($errors['price']) ? 'is-invalid' : ''; ?>" id="price" name="price" value="<?php echo htmlspecialchars($values['price']); ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control <?php echo isset($errors['sale_price']) ? 'is-invalid' : ''; ?>" id="sale_price" name="sale_price" value="<?php echo htmlspecialchars($values['sale_price']); ?>">
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="is_free" name="is_free" <?php echo $values['is_free'] ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="is_free">Free Course</label>
                                </div>
                            </div>
                            <div class="col-md-3 d-flex align-items-center">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" <?php echo $values['is_featured'] ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="is_featured">Featured Course</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label for="thumbnail" class="form-label">Thumbnail URL</label>
                                <input type="url" class="form-control" id="thumbnail" name="thumbnail" value="<?php echo htmlspecialchars($values['thumbnail']); ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="preview_video" class="form-label">Preview Video URL</label>
                                <input type="url" class="form-control" id="preview_video" name="preview_video" value="<?php echo htmlspecialchars($values['preview_video']); ?>">
                            </div>
                            <div class="col-12">
                                <label for="description" class="form-label">Course Description</label>
                                <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($values['description']); ?></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="requirements" class="form-label">Requirements</label>
                                <textarea class="form-control" id="requirements" name="requirements" rows="4"><?php echo htmlspecialchars($values['requirements']); ?></textarea>
                                <div class="helper-text">One requirement per line.</div>
                            </div>
                            <div class="col-md-4">
                                <label for="what_you_learn" class="form-label">What You'll Learn</label>
                                <textarea class="form-control" id="what_you_learn" name="what_you_learn" rows="4"><?php echo htmlspecialchars($values['what_you_learn']); ?></textarea>
                                <div class="helper-text">One item per line.</div>
                            </div>
                            <div class="col-md-4">
                                <label for="target_audience" class="form-label">Target Audience</label>
                                <textarea class="form-control" id="target_audience" name="target_audience" rows="4"><?php echo htmlspecialchars($values['target_audience']); ?></textarea>
